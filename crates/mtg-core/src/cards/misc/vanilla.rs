...
pub fn register(db: &mut CardDb) {
    ...
    // Evergreen-keyword creatures (Scryfall-verified single-keyword bodies). Subtypes are a set
    // (CR 205.3m) — two-subtype bodies like "Human Soldier" just pass `&[Human, Soldier]`.
